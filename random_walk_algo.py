...
# have: a module
# have: a list of related modules

"""
Select random module from list of related modules
If module links to no other modules, return False and go back to original list
Pop off that module
Otherwise, find the list of all the modules
Then, repeat
"""

test_mod = 'CN6163'
all_visited_mods = [test_mod]
random_mod = get_mod_data(test_mod)
